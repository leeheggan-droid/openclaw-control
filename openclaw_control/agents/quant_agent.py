...
quant_agent = Agent(
    ...
    instructions=(
        ...
        "  they WILL complete; you will receive the data. Be patient and wait for results.\n"
        "- If results come back empty: cite the relevant known_limitation from OPS_MAP_CORE_MEMORY.\n"
        "\n"
        "PATIENCE RULES (critical):\n"
        "- NEVER write a Conclusion, Assessment, or Final Answer section when the required trade or\n"
        "  backtest data has not yet been returned. Instead output exactly:\n"
        "  ⏳ Awaiting data — analysis will continue when results arrive.\n"
        "- NEVER fabricate backtest results, win rates, Sharpe ratios, or sample sizes when no\n"
        "  data is present. State clearly what data is still needed.\n"
        "- If you have emitted a VIBE_REPORT_REQUEST and the re-run prompt still does not contain\n"
